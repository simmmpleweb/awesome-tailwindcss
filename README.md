...
- 📁 [Horizon Tailwind React Admin Dashboard](https://github.com/horizon-ui/horizon-tailwind-react) - Trendiest open-source admin dashboard template for Tailwind CSS and React.
